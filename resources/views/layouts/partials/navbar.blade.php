<nav class="navbar navbar-expand-lg sticky-top" 
    style="background: rgba(255, 255, 255, 0.9); backdrop-filter: blur(10px); border-bottom: 1px solid rgba(0,0,0,0.05); padding: 0.75rem 1.0rem; z-index: 1040;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-xl border-0 mt-3 p-2 rounded-4">
                            <li>
                                <div class="px-3 py-2 d-lg-none">
                                     <p class="mb-0 fw-bold text-black small">{{ Auth::user()->nama_lengkap }}</p>
                                     <p class="mb-0 text-muted small text-uppercase">{{ str_replace('_', ' ', Auth::user()->role) }}</p>
