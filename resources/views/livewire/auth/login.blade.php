<div class="main-auth-viewport"> <div class="container-fluid h-100 d-flex align-items-center justify-content-center p-0">
            ...
            <div class="col-11 col-sm-8 col-md-6 col-lg-4 col-xl-3">
                ...
                <div class="card border-0 shadow-2xl bg-white animate__animated animate__fadeInUp login-card-container">
                    ...
                    <form wire:submit.prevent="login">
                        <div class="mb-4">
                            ...
                            <input type="text" wire:model="idlogin" 
                                   ...
                                   placeholder="Username or ID login" autofocus>
                            @error('idlogin') 
                    ...
                    <div class="mt-5 text-center footer-copyright">
                        <p class="mb-0">
                            Official Inventory &copy; 2026 <strong>PSTORE GROUP</strong>
                        </p>
                    </div>
                </div>
    ...
    <style>
        /* CSS Menjamin Full Viewport & Responsif */
        .main-auth-viewport {
            position: fixed;
            top: 0;
            left: 0;
            ...
            z-index: 99999;
            overflow-y: auto; /* Memungkinkan scroll jika di HP sangat kecil */
        }
        ...
        /* Penyesuaian khusus Perangkat Mobile */
        @media (max-width: 576px) {
            ...
            h2 { font-size: 1.5rem; }
            .main-auth-viewport { padding: 20px 0; }
        }
