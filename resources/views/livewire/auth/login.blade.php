                    ...
                    <form wire:submit="login">
                        <div class="mb-4">
                            ...
                            <input type="text" wire:model="idlogin" 
                                   class="form-control border-0 bg-light py-3 px-4 shadow-none custom-foc-input @error('idlogin') is-invalid @enderror" 
                        ...
                        <div class="mb-5">
                            ...
                            <input type="password" wire:model="password" 
                                   class="form-control border-0 bg-light py-3 px-4 shadow-none custom-foc-input @error('password') is-invalid @enderror" 
                                   placeholder="••••••••">
                            @error('password') 
                                <span class="text-danger extra-small mt-2 d-block px-1 fw-semibold">
                                    {{ $message }}
